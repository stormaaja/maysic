...
[1,1,(_1) => { __ = _1 }],
[2,0],
[2,3,(_1,_2,_3) => {  __ = { type: 'ASSIGN', left: _1, right: _3}  }]];

/**
 * Encoded tokens map.
 */
const tokens = {"ID":"3","NUMBER":"4","'='":"5","$":"6"};

/**
 * Parsing table (generated by Syntax tool).
 */
const table = [{"0":1,"1":2,"2":3,"3":"s4","6":"r1/r3/r5"},{"6":"acc"},{"6":"r2"},{"6":"r4"},{"5":"s5"},{"4":"s6"},{"6":"r6"}];
...
[/^[a-z][a-zA-Z0-9_]*/, function() { return 'ID' }],
[/^=/, function() { return "'='"; }]];
const lexRulesByConditions = {"INITIAL":[0,1,2,3]};
