...
describe("parsing assignment", function () {
  it("produces assignment tree", function () {
...
describe("parsing function", function () {
  it("produces function without args", function () {
  ...
  it("produces function with two params", function () {
...
describe("parsing function call", function () {
  it("produces function call tree", function () {
  ...
  it("produces function call with symbols", function () {
